...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
        ...
        LSFT_T(KC_CAPS), KC_Z,  KC_X,    KC_C,    KC_V,    KC_B,    MS_BTN1, MS_BTN1,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, RSFT_T(KC_ENT) /*KC_ENT*/,
        LT(_SODA, KC_GRV), KC_LCTL, KC_LALT, KC_LGUI, LT(_LOWER, KC_BSLS), LT(_SPACE, KC_SPC), KC_SCRL, MS_BTN2, KC_BSPC, LT(_RAISE, KC_NONUS_BACKSLASH), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT
    ),
    ...
    [_LOWER] = LAYOUT(
        ...
        _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  MS_BTN1, MS_BTN1,  KC_F12,  DOLLAR_SIGN, CURLY_OPEN, CURLY_CLOSE, KC_GRV, LSFT(KC_GRV),
        _______, _______, _______, _______, _______, _______, KC_SCRL, MS_BTN2, _______, _______,   SQUARE_OPEN, SQUARE_CLOSE, LSFT(KC_2), KC_NONUS_BACKSLASH
    ),
    ...
    [_RAISE] = LAYOUT(
        ...
        _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  MS_BTN1, MS_BTN1,  KC_F12,  HASHTAG, KC_NUBS, TILDE, BACKTICK, KC_GRV,
        _______, _______, _______, _______, _______, _______, KC_SCRL, MS_BTN2,_______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
    ),
    ...
    [_SODA] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, KC_SCRL, MS_BTN2, _______, _______, _______, _______, KC_BRMD, KC_BRMU
    ),
    ...
    [_NUMPAD] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, KC_SCRL, MS_BTN2, KC_BSPC,  KC_P0, KC_P0, KC_SLSH, KC_PDOT, KC_PEQL
    ),
};
