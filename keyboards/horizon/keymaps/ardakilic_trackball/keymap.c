...
[_QWERTY] = LAYOUT(
    ...
    LT(_SODA, KC_GRV), KC_LCTL, KC_LALT, KC_LGUI, LT(_LOWER, KC_BSLS), LT(_SPACE, KC_SPC), BALL_SCR, MS_BTN2, KC_BSPC, LT(_RAISE, KC_NONUS_BACKSLASH), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT
),
...
[_LOWER] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______, BALL_SCR, MS_BTN2, _______, _______,   SQUARE_OPEN, SQUARE_CLOSE, LSFT(KC_2), KC_NONUS_BACKSLASH
),
...
[_RAISE] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______, BALL_SCR, MS_BTN2,_______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),
