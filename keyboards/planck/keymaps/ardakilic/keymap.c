...
[_QWERTY] = LAYOUT_planck_mit(
    ...
    LT(_SODA, KC_GRV), KC_LCTL, KC_LALT, KC_LGUI, LT(_LOWER, KC_BSLS), LT(_SPACE, KC_SPC),  LT(_RAISE, KC_NONUS_BACKSLASH), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT
),
...
[_LOWER] = LAYOUT_planck_mit(
    ...
    _______, _______, _______, _______, _______,      KC_ENT,      _______,   SQUARE_OPEN, SQUARE_CLOSE, LSFT(KC_2), KC_NONUS_BACKSLASH
),
 ...
 *                      v------------------------RGB CONTROL--------------------v
 * ,-----------------------------------------------------------------------------------.
 * |EepRST|BotLdr|Debug | RGB  |RGBMOD| HUE+ | HUE- | SAT+ | SAT- |BRGTH+|BRGTH-|  Del |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |Reboot|      |MUSmod|Aud on|Audoff|AGnorm|AGswap|      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT_planck_mit(
    EE_CLR, QK_BOOT, DB_TOGG,   UG_TOGG, UG_NEXT, UG_HUEU, UG_HUED, UG_SATU, UG_SATD,  UG_VALU, UG_VALD, KC_DEL ,
    QK_RBT, _______, QK_MUSIC_MODE_NEXT,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, _______, _______, _______, _______, _______,
