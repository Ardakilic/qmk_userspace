...
[_NUM] = LAYOUT_ansi(
  ...
  KC_LSFT, KC_Z, KC_X, KC_C, KC_V,_______, KC_PDOT, KC_PDOT, KC_PDOT,_______,_______,_______, KC_MS_U, MS_BTN2, \
  KC_LCTL, KC_LGUI, KC_LALT,KC_P0,_______,_______,MS_BTN1,KC_MS_L,KC_MS_D, KC_MS_R
),
