...
[_NUM] = LAYOUT_ansi(
  ...
  KC_LSFT, KC_Z, KC_X, KC_C, KC_V,_______, KC_PDOT, KC_PDOT, KC_PDOT,_______,_______,_______, MS_UP, MS_BTN2, \
  KC_LCTL, KC_LGUI, KC_LALT,KC_P0,_______,_______,MS_BTN1,MS_LEFT,MS_DOWN, MS_RGHT
),
